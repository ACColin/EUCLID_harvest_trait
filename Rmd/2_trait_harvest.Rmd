...
classification_df <- 
    ...
    mutate(genus = word(name, 1) %>% str_to_title(),
            ...
            species = get_level(name, "^corymbia"),
...
# The species are not missing description for min_width and min_length but I can't figure out why yet. 
...
# Manually add the fruit_length_mm_min and fruit_length_mm_max
# for Corymbia aspera, Corymbia plena and Corymbia rhodops.
